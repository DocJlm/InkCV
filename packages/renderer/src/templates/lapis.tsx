...
export function LapisTemplate({ doc, theme }: TemplateProps): React.ReactElement {
  const styles = buildTemplateStyles(theme);
  return (
    <Document>
      <Page size={[theme.page.width, theme.page.height]} style={[styles.page, layout.page, { borderLeftWidth: theme.space.rule * 3, borderLeftColor: theme.color.accent }]}>
