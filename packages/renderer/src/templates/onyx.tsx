...
export function OnyxTemplate({ doc, theme }: TemplateProps): React.ReactElement {
  const styles = buildTemplateStyles(theme);
  return (
    <Document>
      <Page size={[theme.page.width, theme.page.height]} style={[styles.page, layout.page, { borderTopWidth: theme.space.rule * 3, borderTopColor: theme.color.accent }]}>
